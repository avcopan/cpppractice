...
class TensorShufflingOp : public TensorBase<TensorShufflingOp<Shuffle, XprType> >
{
  ...
  inline TensorShufflingOp(const XprType& expr, const Shuffle& shuffle)
    ...
    inline TensorShufflingOp& operator = (const TensorShufflingOp& other)
    {
    ...
    inline TensorShufflingOp& operator = (const OtherDerived& other)
    {
