...
struct TensorEvaluator
{
  ...
  inline TensorEvaluator(const Derived& m, const Device& device)
      : m_data(const_cast<Scalar*>(m.data())), m_dims(m.dimensions()), m_device(device)
  { }

  inline const Dimensions& dimensions() const { return m_dims; }

  inline bool evalSubExprsIfNeeded(CoeffReturnType* dest) {
    if (dest) {
  ...
  inline Scalar& coeffRef(const array<DenseIndex, NumCoords>& coords) {
    eigen_assert(m_data);
    if (static_cast<int>(Layout) == static_cast<int>(ColMajor)) {
      return m_data[m_dims.IndexOfColMajor(coords)];
    } else {
...
struct TensorEvaluator<const Derived, Device>
{
  ...
  inline bool evalSubExprsIfNeeded(CoeffReturnType* data) {
...
struct TensorEvaluator<const TensorCwiseNullaryOp<NullaryOp, ArgType>, Device>
{
  ...
  const Dimensions& dimensions() const { return m_argImpl.dimensions(); }

  inline bool evalSubExprsIfNeeded(CoeffReturnType*) { return true; }
  inline void cleanup() { }
...
struct TensorEvaluator<const TensorCwiseBinaryOp<BinaryOp, LeftArgType, RightArgType>, Device>
{
  ...
  {
    static_assert((static_cast<int>(TensorEvaluator<LeftArgType, Device>::Layout) == static_cast<int>(TensorEvaluator<RightArgType, Device>::Layout) || internal::traits<XprType>::NumDimensions <= 1), "you made a programming mistake");
  ...
  inline bool evalSubExprsIfNeeded(CoeffReturnType*) {
...
struct TensorEvaluator<const TensorSelectOp<IfArgType, ThenArgType, ElseArgType>, Device>
{
  ...
  {
    static_assert((static_cast<int>(TensorEvaluator<IfArgType, Device>::Layout) == static_cast<int>(TensorEvaluator<ThenArgType, Device>::Layout)), "you made a programming mistake");
    static_assert((static_cast<int>(TensorEvaluator<IfArgType, Device>::Layout) == static_cast<int>(TensorEvaluator<ElseArgType, Device>::Layout)), "you made a programming mistake");
