...
class TensorEvalToOp : public TensorBase<TensorEvalToOp<XprType> >
{
  public:
    ...
    inline TensorEvalToOp(CoeffReturnType* buffer, const XprType& expr)
    ...
    CoeffReturnType* buffer() const { return m_buffer; }
...
struct TensorEvaluator<const TensorEvalToOp<ArgType>, Device>
{
  ...
  inline bool evalSubExprsIfNeeded(CoeffReturnType* scalar) {
