...
such as contractions.  The implementations are optimized for
different environments: single threaded on CPU.
...
presently three devices you can use: DefaultDevice.
...
Tensor.  They can be used to access slices of tensors or see them with different
dimensions.
